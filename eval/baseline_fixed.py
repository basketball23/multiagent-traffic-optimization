...
def get_intersection_metrics(tl_id):
    ...
    return veh_wait_count, veh_wait_time, veh_avg_wait_time, ped_wait_count, ped_wait_time, ped_avg_wait_time
...
def run_fixed_timer():
    ...
    with open('fixed_timer_data.csv', mode='w', newline='') as file:
        ...
        writer.writerow(['step', 'vehicle_total_stopped', 
                         'vehicle_total_waiting_time', 'vehicle_average_waiting_time', 
                         'pedestrian_total_stopped', 'pedestrian_total_waiting_time', 
        ...
        while step < 3600:
            ...
            if step % 5 == 0:
                ...
                for tl_id in tl_ids:
                    v_count, v_time, v_avg, p_count, p_time, p_avg = get_intersection_metrics(tl_id)
