...
def evaluate_and_compare(file1_path, file2_path, label1="MARL Baseline", label2="Pedestrian-Aware MARL Model"):
    ...
    fig.suptitle('Traffic Model Evaluation: MARL baseline vs. Pedestrian-Aware MARL', fontsize=16, fontweight='bold')
...
if __name__ == "__main__":
    ...
    file_a = "rl_no_fairness_data.csv"
