...
num_seeds = 10
sim_dir = "simulation/extreme-demand"
results_dir = "evaluation-results/extreme-demand/marl-no-rew"
...
for i in range(1, num_seeds + 1):
    ...
    veh_file = os.path.join(sim_dir, f"vehs_extreme_seed{seed_value}.rou.xml")
    ped_file = os.path.join(sim_dir, f"peds_extreme_seed{seed_value}.rou.xml")
