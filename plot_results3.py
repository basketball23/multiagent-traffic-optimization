...
# 1. Updated the folders to only compare the two MARL models
folders = {
...
# 2. Updated colors for the two remaining models
colors = {
    'MARL (No Reward)': '#f4a261',       # A contrasting orange/sand color
    'Pedestrian-Aware MARL': '#e63946'   # Keeping the original red for your main model
}
names = list(data.keys())

# Adjusted figsize slightly since we only have 2 bars per graph now, 
# making it slightly narrower so the bars don't look stretched.
